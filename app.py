...
app.layout = html.Div([
    ...
    dcc.Markdown("""
                 ...
                 Users can also select/de-select multiple items at a time to compare calories, or to calculate the total calories of the items they want. In the bottom of the dashboard, users may also choose one of the three important nutritional values (total sugars, total fat, and protein) from the dropdown. Once the user chooses a value, a pie chart will display the amounts of the value containing in different items we have. When the user places
